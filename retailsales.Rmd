...
* Fuel Price looks fairly normally distributed
* Weekly Sales is positively skewed. This could be due certain holidays causing our sales to peak so we wont try to fix it since it might helps shed light in our analysis.

...
*  Here, the **Residual standard error** is 1.66.

* The **adjusted r-squared** value measures how much of the variation in the response variable is explained  by the set of predictors. In this case 90.7% of the variation in `Sales` is explained by the set of predictors. But this does not necessarily mean that the model will predict new data accurately.

...
I map each country to it's respective continent. I had to custom match Kosovo because it wasn't mapping for some reason
...
We use geom point to show the relationship between the various life factors and the happiness score.
I added a geom smooth with a linear regression method to properly see the direction of the linear relationship.

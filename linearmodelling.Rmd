...
Linear regression is one of the most common type of **machine learning methods**[cite]
Linear regression is a supervisd learneng algorithim used to predict a continous dependent variable (Y) based on the value of one or more independent variables (X) which can be continous or discrete. It attempts to model the relationship between the variables by fitting a linear equation to the observed data.
...
> <font size="4"> Calculate the prediction accuracy > <font size="4"> 
...
The fit of the model is thus $speed\ of\ adoption =40.823-0.0994worth\ of\ firm-6.892 type\ of\ firm$
